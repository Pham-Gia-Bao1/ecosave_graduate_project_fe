...
export default function OrderHistory() {
  ...
  const viewRouteToTheStore = (order: OrderData) => {
    ...
    document.cookie = `storeLocation=${encodeURIComponent(
      JSON.stringify([storeLat, storeLng])
    )}; path=/; secure`;
    router.push('/map/direction')
  };
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        >
          <strong className="font-bold">
            Không thể tải lịch sử đơn hàng, vui lòng quay lại sau!{" "}
          </strong>
        </div>
      </div>
    );
                ...
                <div className="flex flex-wrap justify-between items-center gap-4">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-medium">
                      {order.order_date.toLocaleDateString("vi-VN")}
                    </p>
              ...
              <div className="p-6 bg-gray-50 border-l">
                ...
                <div className="space-y-3">
                  {order.status === "completed" ? (
                    ...
                    <button
                      onClick={() => viewRouteToTheStore(order)}
                      className="w-full py-2 px-4 bg-orange-500 text-white rounded-md text-sm font-medium hover:bg-orange-600 transition-colors"
                    >
